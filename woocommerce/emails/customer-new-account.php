...
<?php if ( $email_improvements_enabled ) : ?>
	...
	<p><?php printf( esc_html__( 'Děkujeme za vytvoření Vašeho uživatelského účtu. Níže jsou uvedené Vámi vyplněné osobní informace.', 'woocommerce' ), esc_html( $blogname ) ); ?></p>
	<div class="hr hr-top"></div>
	<?php /* translators: %s: Username */ ?>
	<p><?php echo wp_kses( sprintf( __( 'Uživatelské jméno: <b>%s</b>', 'woocommerce' ), esc_html( $user_login ) ), array( 'b' => array() ) ); ?></p>
	...
	<p><?php echo esc_html__( 'Pro přístup do svého účtu, kde můžete zobrazit objednávky, změnit heslo a další, použijte následující odkaz:', 'woocommerce' ); ?></p>
